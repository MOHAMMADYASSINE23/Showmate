      ...
      <nav className="bg-white border-b-2 border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          <Link to="/" className="flex items-center">
              ...
              <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Showmate</span>
          </Link>
          ...
          <button onClick={toggleDarkMode} data-tooltip-target="navbar-search-example-toggle-dark-mode-tooltip" type="button" data-toggle-dark="light" className="flex items-center p-2 mr-2 text-xs font-medium text-gray-700 bg-white rounded-lg border border-gray-200 toggle-dark-state-example hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-500 dark:bg-gray-800 focus:outline-none dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
            ...
            <button onClick={() => setHidden(!hidden)} type="button" data-collapse-toggle="navbar-search" aria-controls="navbar-search" aria-expanded="false" className="md:hidden text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 mr-1" data-testid="mobile-search-toggle">
            ...
            <form onSubmit={handleSearch} className="hidden relative md:flex" data-testid="search-form">
              ...
              />
              <button type="submit" aria-label="Search" className="ml-2 px-4 py-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-transparent hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Search
              </button>
            </form>
            ...
            <div className={`${hidden ? "hidden" : ""} justify-between items-center w-full md:flex md:justify-center md:flex-1 md:order-1`} id="navbar-search">
              <form onSubmit={handleSearch} className="relative mt-3 md:hidden">
                ...
                <input
                  ...
                  onChange={(e) => setSearchTerm(e.target.value)}
                />
                <button type="submit" aria-label="Search" className="absolute right-2 top-1/2 transform -translate-y-1/2 px-2 py-1 text-sm font-medium text-white bg-blue-700 rounded hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  Search
                </button>
              </form>
              <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white md:overflow-x-auto dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                ...
                <li>
                  <NavLink to="/favorites" className={({isActive}) => isActive ? activeClass : inActiveClass }>Favorites</NavLink>
                </li>
                <li>
